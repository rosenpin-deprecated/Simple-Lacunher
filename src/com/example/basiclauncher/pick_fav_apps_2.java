...
public class pick_fav_apps_2 extends Activity {
    PackageManager packageManager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        packageManager = getPackageManager();
        AlertDialog.Builder app_dialog = new AlertDialog.Builder(pick_fav_apps_2.this);
        ...
        apps.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                edit.commit();
                startActivity(new Intent(getApplicationContext(),pick_fav_apps_3.class));
                finish();
            }
        });
        app_dialog.setTitle("Pick your second favorite app");
