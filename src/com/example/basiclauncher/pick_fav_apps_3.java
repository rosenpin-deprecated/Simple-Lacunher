 ...
 */
public class pick_fav_apps_3 extends Activity {
    PackageManager packageManager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        packageManager = getPackageManager();
        AlertDialog.Builder app_dialog = new AlertDialog.Builder(pick_fav_apps_3.this);
        ...
        apps.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                edit.commit();
                startActivity(new Intent(getApplicationContext(),pick_fav_apps_4.class));
                edit.putBoolean("initialized",true);

                finish();
            }
        });
        app_dialog.setTitle("Pick your 3rd favorite app, we are almost done!");
