...
public class map extends Activity implements GoogleMap.OnMarkerClickListener{
    ...
    Event ehudBirthDay = new Event();
    Event middayParty = new Event();
    Event ArgentinaVsIran = new Event();
    Event newCodeBirthDay = new Event();
    ...
    public void initializeMarkers(){
        TestAdapter mDbHelper = new TestAdapter(map.this);
    ...
    public void initializeEvents(){
        ...
        events.add(ehudBirthDay);
        events.add(middayParty);
        events.add(ArgentinaVsIran);
        events.add(newCodeBirthDay);
    }
        ...
        if(!marker.equals(me)){
            ...
            for (int i = 0; i < events.size(); i++){
                ...
                if(marker.equals(events.get(i).eventMarker)){
                    AlertDialog.Builder markerDialog = new AlertDialog.Builder(map.this);
